...
from zeromq_mt4_cliente_v1_8 import zeromq_mt4_ea_client
...
def get_ganancia():
    ...
    hoja=doc.get_sheet_by_name("TE CHF-JPY")                #El usuario debe seleccionar y escribir el nombre de la hoja a escanear, se guarda en la variable hoja
